...
def cadastro():
    print('Preencha os dados do novo cliente abaixo:')
    nome = input("Nome: ")
...
def alterar_senha(agenda):
    ...
    nome_busca = input('Digite o nome do cliente que você deseja alterar a senha: ')
    ...
    if indice_alteracao != -1:
        ...
        print('Desculpe, cliente não encontrado...')
...
while True:
    ...
    if opção == 1:
        ...
        # buscar cliente
        nome_buscar = input("Digite o nome do cliente que voçê deseja buscar: ")
